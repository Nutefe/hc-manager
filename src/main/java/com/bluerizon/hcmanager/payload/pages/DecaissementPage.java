...
public class DecaissementPage {
    ...
    private Long from;
    private Long to;
    private List<Decaissements> data;

    public DecaissementPage() {
    }
    ...
    public List<Decaissements> getData() {
        return data;
    }

    public void setData(List<Decaissements> data) {
        this.data = data;
    }
}
