...
public class EncaissementPage {
    ...
    private Long from;
    private Long to;
    private List<Encaissements> data;

    public EncaissementPage() {
    }
    ...
    public List<Encaissements> getData() {
        return data;
    }

    public void setData(List<Encaissements> data) {
        this.data = data;
    }
}
