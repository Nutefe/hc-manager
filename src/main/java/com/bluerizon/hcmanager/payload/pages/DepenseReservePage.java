...
public class DepenseReservePage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<DepenseReserves> data;

    public DepenseReservePage() {
    }
    ...
    public List<DepenseReserves> getData() {
        return data;
    }

    public void setData(List<DepenseReserves> data) {
        this.data = data;
    }
}
