...
public class TypeTraitementPage {
    private Long total;
    ...
    private Long from;
    private Long to;
    private List<TypeTraitements> data;

    public TypeTraitementPage() {
    }
    ...
    public List<TypeTraitements> getData() {
        return data;
    }

    public void setData(List<TypeTraitements> data) {
        this.data = data;
    }
}
