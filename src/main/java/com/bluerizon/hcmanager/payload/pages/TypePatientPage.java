...
public class TypePatientPage {
    ...
    private Long from;
    private Long to;
    private List<TypePatients> data;

    public TypePatientPage() {
    }
    ...
    public List<TypePatients> getData() {
        return data;
    }

    public void setData(List<TypePatients> data) {
        this.data = data;
    }
}
